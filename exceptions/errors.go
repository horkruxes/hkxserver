...
var ErrorTooSoonUnregistered = errors.New("when not registered on a pod, you must wait 1 hour after the last message posted on the server too avoid spam")
var ErrorTooSoonRegistered = errors.New("when registered on a pod, you must wait 5 min after the last message posted on the server too avoid spam")
